...
- Homework deadlines. Homework assignments are due at 10:00am on the dates specified in the course calendar.
...
1. In 3-hour class sessions, attendance for the post-exam review session (Zoom) may be recorded; students are required to log in during the review portion to register attendance.
...
**What are typical questions?** While past exams may be available (since I allow students to keep their copies), the course content evolves and questions change each semester. Still, reviewing older exams can help you understand the general format and types of questions. Exams often include tasks that require using R and/or Python, typically focused on analyzing and interpreting data or results. Homework assignments include applied, research-oriented questions that require writing code in R and/or Python, learning new concepts, and conducting some independent research. You are not alone in this process: you have access to the resources outlined in the syllabus, including support through Zoom sessions, DataLab discussions, meetings, and email.
