...
1. DataLab is the platform used for completing evaluated activities such as assignments and exams. The format for these activities is ipynb or Jupyter notebook. This means that it is not acceptable to submit documents in other formats, such as PDF or MS Word, and upload them to DataLab.
