...
**Individual or in groups?** All exams $E_1$, $E_2$, and $E_F$ are group activities, with a maximum of 4 students per group. These groups will also be used for the homework assignments $H_1$ and $H_2$. Your group will have private access to a Datalab project, where only your group members and I will have editing privileges. Please see @sec-policies for further details about group policies.
