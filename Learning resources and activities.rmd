...
We have two partial exams, $E_1$ and $E_2$, which together contribute 40% to the final grade, as well as one final exam, $E_F$, which accounts for 30% of the final grade. In total, these three exams represent 70% of the final grade, while the remaining 30% consists of two homework assignments, denoted as $H_1$ and $H_2$. In sum: 40% partial exams, 30% assignments, 30% final exam.
...
**Individual or in groups?** All exams $E_1$, $E_2$, and $E_F$ are group activities, with a maximum of 4 students per group. These groups will also be used for the homework assignments $H_1$ and $H_2$. Your group will have private access to a DataLab workbook, where only your group members and I will have editing privileges. Please see @sec-policies for further details about group policies.
...
**What are the mechanics?** The exam instructions will be available to you in an electronic format (.ipynb file) according to the course calendar. These instructions will automatically appear in Blackboard 5 minutes before the start of the class session. Once the .ipynb file is available, you will need to download it and upload it to your own DataLab workbook, which should be named after your group. You and your group members will then collaborate online to solve the exam within the given time frame. There is no need to submit your exam file separately, as I have access to your DataLab workbook and can make an electronic copy for review and grading. It is important to ensure that you finish the exam before the specified time deadline. A few days later, you will receive your group's mark, along with comments and feedback. Please note that during the exam, I may quietly visit your notebook to monitor your progress `r fontawesome::fa("eye")`.

**How does DataLab work?**
It is possible that this is your first time working with "Jupyter Notebooks." DataCamp includes a feature called DataLab, where each team has access to a private "workbook." This is a secure workspace where only your team and I, as your instructor, have access. DataLab workbooks can load and create "notebooks," which are files with the .ipynb extension. Each notebook is a collaborative document, similar to an MS Word document, that supports R and Python code, professional mathematical notation, markdown, and text. Notebooks can be organized into folders within a workbook. The homeworks and exams instructions will be provided as notebooks, which you must upload to your workspace to complete the activities and answer the exam questions.
...
$\displaystyle \sum_{n=1}^{3} (n+1) = (1+1) + (2+1) = 2 + 3 = 5$.
...
To complete the XP assignments, you will need to choose courses, skill tracks, career tracks, practice exercises, and other types of DataCamp content on your own. You are free to select based on your personal interests and preferences. However, if you would like some guidance, I recommend starting with basic or fundamental R courses, as well as finance courses with R. Other options include Python, SQL, Tableau, Power BI, Excel, ChatGPT, and more. Visit the "Learn" section on DataCamp to browse, search, and filter all available learning content to accumulate XP. Feel free to contact me if you would like further advice on which courses to take.
