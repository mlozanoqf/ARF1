...
As with any extra mark activity, you do not lose marks if you fail to complete them, but you can get extra marks over your next individual exam if you complete them on time. If you were taking two courses with me in the past, the extra marks that you earned in one course were also valid for the second and vice versa. Sadly, this benefit was recently canceled due to strong complaints from some students who considered it unfair.
...
For example, if there are 7 activities (DataCamp and UN CC:Learn courses) in the semester allocated as 3 in the first partial, 2 in the second, 2 in the third, and you complete all of them on time, for the $E_1$ you earn:

$\displaystyle \sum_{n=1}^{3} (n+1) = (1+1) + (2+1) + (3+1) = 2 + 3 + 4 = 9$.
...
However, if there are 7 activities (DataCamp and UN CC:Learn courses) in the semester allocated as 3 in the first partial, 2 in the second, 2 in the third, and you complete one in each period, you earn:
...
* In case UN CC:Learn does not allow you to obtain a newer dated certificate, you can substitute it with one of the following: (1) Indicators for an inclusive green economy: Advanced course; (2) Green Fiscal Policy; (3) Green Economy and Trade; (4) Carbon Taxation; (5) Open Online Course on Gender and Environment; (6) other you may want to do given my written authorization. If this is the case, please let me know and share your certificate with me by email before the deadline so I can assign the corresponding extra marks.
...
list(fecha_final = fecha_final, dia_semana = dia_semana)
```
