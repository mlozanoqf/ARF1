...
Academic resources refer to various materials, tools, and sources of information that are specifically designed to support and enhance learning, research, and scholarly pursuits in an academic setting. These resources play a crucial role in facilitating the acquisition of knowledge, promoting critical thinking, and advancing scholarly activities within the academic community.
...
This course is conducted in Spanish and English. Most learning resources are in English, and exams and homework assignments are submitted in English. However, discussion forums, emails, and class sessions are conducted in Spanish. 

The learning activities are classified as graded, non-graded, and extra marks. All graded activities represent 100% of your final grade. Non-graded activities are relevant for your learning but are not included in the grading process. Therefore, if you fail to complete them, there will be no mark deduction. Extra marks are applied as a bonus to your next partial exams or final exam.

The learning activities are also classified as individual and group activities. 

## `r fontawesome::fa("brain")` Learning resources.

Here is a list and description of the available resources for you to learn the subject. My advice is to utilize as many resources as possible, as they will enable you to grasp the subject matter and develop the necessary professional competences required.
...
**Class sessions.** We will explain and discuss specific topics, address questions, review your study progress, and occasionally conduct brief activities during class sessions. Please note that the available time in class sessions is limited, and we may not be able to cover every topic in full detail. Instead, we will utilize other resources and learning activities to cover the remaining topics. It is expected that you attend on time, actively participate, and engage in our discussions. I recommend using your computer during the sessions as you may need to access an IDE, view the PDF textbook, or refer to your own homework.

For Zoom sessions, it is fine if you prefer to keep your microphone on and your camera either on or off, as we will often be sharing the screen during class. To ensure convenience, unless otherwise specified, class Zoom sessions are recorded and accessible to you. Please note that internet service may occasionally fail during class sessions, but this is a risk we all face. The Zoom link to join the class can be found in Blackboard.

Watch the following video for a valuable recommendation from Prof. Fleisch, applicable to both online and face-to-face sessions:
...
## `r fontawesome::fa("check")` Graded activities. Exams: $E_1$, $E_2$ and $E_F$. 

We will have two partial exams, $E_1$ and $E_2$, which together contribute 40% to the final grade, as well as one final exam, $E_F$, which accounts for 30% of the final grade. In sum, these three exams represent 70% of the final grade, and the remaining 30% consists of homework assignments $H$.

All the topics covered in this course are subject to evaluation in the exams. If you aim to achieve an outstanding final grade, I strongly advise you to take thorough class notes throughout the semester.
...
**Where?** Physical presence in the classroom is not required for taking the exams. You can complete the exams from any location of your choice, as they are conducted, answered, and submitted entirely in electronic format. Just ensure that you have a stable internet connection. I will be available during the exams through Zoom, and while joining the Zoom session is not mandatory, please be aware that I will be accessible in case you need any assistance. The Zoom link for the exams is the same as the one assigned to the course. It is important to note that for 3-hour class sessions, the first part of the session is dedicated to taking the exam. During the second part of the class, you will need to log in to the Zoom session to review and discuss the answers for the $E_1$ and $E_2$ exams.
...
**Individual or in groups?** All exams $E_1$, $E_2$, and $E_F$ are group activities, with a maximum of 4 students per group. If there are more than 4 students in a group, a significant mark deduction will be applied. You have the freedom to define your own groups, and these groupings will remain fixed throughout the semester. Each group will be assigned a name corresponding to a Jupiter moon. These groups will also be used for the homework assignments $H$. Please note that the class list may change during the semester due to late enrollments or dropouts. In such cases, group members may change, but the maximum number of students per group will remain the same. Your group will have private access to a Deepnote project, where only your group members and I will have editing privileges.

**What are the mechanics?** The exam instructions will be available to you in an electronic format (.ipynb file) according to the course calendar. These instructions will automatically appear in Blackboard 5 minutes before the start of the class session. Once the file is available, you will need to download it and upload it to your own Deepnote project, which should be named after your group (the name of a Jupiter moon). You and your group members will then collaborate online to solve the exam within the given time frame. There is no need to submit your exam file separately, as I have access to your Deepnote project and can make an electronic copy for review and grading. It is important to ensure that you finish the exam before the specified time deadline. A few days later, you will receive your group's mark, along with comments and feedback, in the Deepnote read-only project. Please note that during the exam, I may quietly visit your notebook to monitor your progress `r fontawesome::fa("eye")`.

**Do all group members receive the same mark?** Not necessarily. Individual activities may contribute to earning extra marks. Additionally, if a group member fails to contribute, they will receive a zero mark for that particular activity. While I assign a group mark that is the same for all group members, you are also required to complete an auto and co-evaluation. Your individual exam mark is a combination of the group mark assigned by me and the auto and co-evaluation marks assigned by you and your colleagues. Please find the full details below.
...
**Mock exams.** We have three mock exams $ME_1$, $ME_2$ and $ME_F$. These are similar to regular exams, taken during class before the real and graded $E_1$, $E_2$ and $E_F$ exams. They represent an opportunity to get familiar with the examination process, logistics and level of difficulty of the real and graded exams. Mock exams are group activities, usually one or two questions. Only if your group answers the question 100% correctly then your group will receive 2 stickers on your next partial or final exam. If not, your group will lose 5 marks on your next partial or final exam. We will review the correct answers after the deadline. 


## `r fontawesome::fa("check")` Graded activities. Homework assignments: $H_1$, $H_2$ and $H_3$. 
...
**DataCamp and UN CC:Learn courses.** You will earn extra marks over your next exam, it could be $E_1$, $E_2$ or $E_F$. These activities will be available for you to complete in your DataCamp Assignments section or UN CC:Learn courses, and listed in the course calendar as *extra marks* tag. DataCamp's projects and courses can be completed in a few hours, but skill tracks and career tracks require more time as they include more than one regular course. The amount of extra marks is a function of the cumulative number of activities during the semester. In particular, you earn $n+1$ extra marks per activity $n$. 

For example, if there are 7 activities in the semester and you complete all of them on time, you earn a total of:
...
df <- data.frame("Activity completed" = x, "Extra marks per activity" = single, 
                 "Cumulative" = cumulative)
df
```

According to this example, extra marks will be assigned as: 2, 3, 4, 5, 6, 7, and 8. See the course calendar for the correspondent deadlines of DataCamp activities. 

I may also include courses from The One UN Climate Change Learning Partnership, [UN CC:Learn](https://www.uncclearn.org/).

```{r echo=FALSE}
embed_url("https://youtu.be/5B8eajiYzjE")
```

Some students may have completed a DataCamp or UN CC:Learn activity. If your certificate is older than the starting date of this current academic term, then it is not valid. In case DataCamp does not allow you to obtain a newer dated certificate, you can substitute it with one of the following DataCamp Career Tracks: (1) R programmer; (2) Data Scientist with R; (3) Data Analyst with R; (4) Quantitative Analyst with R; (5) Statistician with R; (6) Machine Learning Scientist with R; (5) Python Programmer; (6) Data Scientist with Python; (7) Data Analyst with Python; (8) Machine Learning Scientist with Python; or (9) Data Scientist Professional with Python. If this is the case, please let me know and share your certificate with me by email before the deadline so I can assign the corresponding extra marks.
