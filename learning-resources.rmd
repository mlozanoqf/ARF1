...
For the official rules on group size, group changes, expulsions, and team agreements, see [Group policies](<course-policies.rmd#sec-gp>).
...
For attendance and tardiness rules, see [Tardiness policies](<course-policies.rmd#sec-tp>).
...
```{=html}
<div class="video-embed">
  <iframe src="https://www.youtube-nocookie.com/embed/XoHx_UIgtt0" title="YouTube video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
```
...
For the official rules on DataLab format, location, backups, and exceptional platform failures, see [Activities policies](<course-policies.rmd#sec-ap>).
