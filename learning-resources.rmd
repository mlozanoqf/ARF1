...
For the official rules on team size, team changes, expulsions, and team agreements, see [Team policies](<course-policies.rmd#sec-gp>).
...
For attendance and tardiness rules, see [Attendance and tardiness policies](<course-policies.rmd#sec-tp>).
...
For the official rules on DataLab format, location, backups, and exceptional platform failures, see [Activity rules and consequences](<course-policies.rmd#sec-ap>).
