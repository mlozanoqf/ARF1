...
* **A workspace.** The workspace name consists of the semester ID and the course ID. Additionally, each workspace has a corresponding picture located at the top left corner. For instance, I teach the following courses: P24ARF1 (depicted by a yellow cat), P24ARF2 (represented by a red bird), and P24EMF (symbolized by a dog), P24FCF (represented by a lion).

<!-- , and P24IF (illustrated by a frog). -->

* **Projects.** Within each workspace, there are three main projects. The first project is named after the course (ARF1, ARF2, EMF, or FCF), and it is open for editing by the entire class. The second project is a read-only project that contains feedback, activity instructions, and exam solutions. The third project is named after your group. This project is private and can only be edited by your group and me.
