...
1. In face-to-face classes, I allow my students to attend via Zoom once per semester as an exception. If this applies to you, please notify me by email. If it happens a second time, the student may still attend via Zoom, but I will record an absence in accordance with current university regulations.
