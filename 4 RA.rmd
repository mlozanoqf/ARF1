...
<a id="sec-gp"></a>
`r fontawesome::fa_i("fa-file-signature", class = "fa-solid")` Groups policies.
...
<a id="sec-tp"></a>
`r fontawesome::fa_i("fa-file-signature", class = "fa-solid")` Tardiness policies:
...
<a id="sec-dcp"></a>
`r fontawesome::fa_i("fa-file-signature", class = "fa-solid")` DataCamp policies.
...
Where $E_F = G_{EF} + X_{EF}$, and no coevaluation is applied to $E_F$. The final exam $E_F$ date may need to be adjusted for administrative reasons in the case of students who are graduate candidates. 

<a id="sec-ap"></a>
`r fontawesome::fa_i("fa-file-signature", class = "fa-solid")` Activities policies.
...
1. All homework assignments and exams submissions, must be sent directly within the DataLab environment in the form of Jupyter notebooks (.ipynb). See [DataCamp policies](#sec-dcp) for more details.
