...
1. **Estimate.**  
Provide an approximate calculation, measurement, or judgment based on available data, information, or assumptions. Clearly state the method or reasoning used to arrive at your estimate and acknowledge its potential limitations.  
...
| Level            | Description                                                                                                               |
|------------------|---------------------------------------------------------------------------------------------------------------------------|
| **3 – Ambitious and In-Depth (86 – 100)**  | The analysis is original, ambitious, and thoroughly developed. It fulfills all the activity instructions, is clear, detailed, and well-grounded. The solution presented is creative, well-structured, and demonstrates a deep understanding of the problem. The analysis is not only in-depth and ambitious but also anticipates and addresses possible problems or limitations in the proposed solution. |
