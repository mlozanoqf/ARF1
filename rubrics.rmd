...
**Oral presentation and oral defense rubric.**

Each of the 5 criteria is worth 20 points, for a total of 100 points. This rubric evaluates the Oral component of homework assignments and partial exams. The final exam has no Oral component. The group mark for homework assignments and partial exams combines the Written component and the Oral component as stated in [Evaluation](evaluation.rmd#sec-evaluation). Written work must follow the course activity rules (see [Activities policies](<course-policies.rmd#sec-ap>)). On-time availability in the correct group workspace and the "submissions" folder is required for the activity to be evaluated. In some cases, specific questions or components of an activity may be evaluated under different or additional criteria. When this applies, it will be clearly stated in the activity instructions or during class session.
...
**Strict presentation policy (no support materials):** Presentations must be delivered in students' own words. The only material available to students is the submitted homework or partial-exam answer displayed on screen. Students may not use written notes, scripts, prepared guides, AI-generated text, AI tools, electronic assistance, or any other support material. Reading aloud, reciting from memory, or closely paraphrasing any prepared script or guide to explain part or all of the work is not allowed. If I determine that scripted delivery is occurring, I may stop or cancel the presentation immediately. In such cases, more than 20% may be deducted from the overall grade.


**How written exams will be evaluated.**

The following criteria will be used to assess the Written component of partial exams and the final exam. They reflect the expectations regarding content, clarity, methodology, language, format, and academic integrity. Please review each item carefully and use them to guide how you prepare and structure your responses. Failing to meet these criteria may result in mark deductions or invalidation of your submission.
...
Exams must comply with: (1) your assigned group rules (see [Group policies](<course-policies.rmd#sec-gp>)), (2) the official timing and deadline rules (see [Activities policies](<course-policies.rmd#sec-ap>)), and (3) the DataLab format and location rules stated in [Activities policies](<course-policies.rmd#sec-ap>). Failure to meet any of these requirements may result in the exam being treated as invalid or not submitted.
...
<!-- ```{r echo=FALSE} -->
<!-- vembedr::embed_url("https://youtu.be/NPwTgfswnD8") -->
<!-- ``` -->
