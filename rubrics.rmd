...
Exams must comply with: (1) your assigned group rules (see [Group policies](<course-policies.rmd#sec-gp>)), (2) the official timing/deadlines (see [Activities policies](<course-policies.rmd#sec-ap>)), and (3) the submission rules in DataLab (see [DataCamp policies](<course-policies.rmd#sec-dcp>)). Failure to meet any of these requirements may result in the exam being treated as invalid or not submitted.
